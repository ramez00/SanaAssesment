...
public class InMemoryCache<TKey, TValue> : ICache<TKey, TValue>
{
    ...
    public InMemoryCache(int capacity, IEvictionPolicy<TKey>? evictionPolicy = null, IEqualityComparer<TKey>? comparer = null)
    {
        ...
        _evictionPolicy = evictionPolicy ?? new LruEvictionPolicy<TKey>(comparer);
    }
